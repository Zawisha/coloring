...
window.onload = function(e){
    ...
    var frontTagClick = $('.front-tag-click');
    console.log(amadoMobNav)
    console.log(frontTagClick)
    ...
    frontTagClick.on('click', function () {
        $('.header-area').removeClass('bp-xs-on');
    });
...
//     var amadoMobNav = $('.amado-navbar-toggler');
//
//     // let amadoMobNav=  document.getElementsByClassName('amado-navbar-toggler');
//     console.log(amadoMobNav)
//     amadoMobNav[0].onclick = function() {
//         alert('Спасибо');
//     };
// }
