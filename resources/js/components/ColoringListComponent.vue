                        ...
                        <div class="card-body text-center">
                            <div class="p-4 border radius-15">
                                ...
                                <div class="list-inline contacts-social mt-3 mb-3">
                                    <span v-if="colored.published_db==1" v-on:click="moderation(index,colored.id)" class="list-inline-item bg-light-border text-white  change_status_col_fai"><i class="bx bx-check "></i></span>
                                    <span v-else v-on:click="moderation(index,colored.id)"  class="list-inline-item bg-light-border text-white  change_status_col_fai"><i class="bx bx-question-mark "></i></span>
                                    <span class="list-inline-item bg-light-border text-white  change_status_col_fai"v-on:click="moderation_delete(index,colored.id)"><i class="bx bxs-x-circle"></i></span>
                                </div>
