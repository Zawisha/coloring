...
export default {
    ...
    mounted() {
        this.get_user_decorated_coloring_list(this.coloring_list);
        this.get_size();
        this.scroll();
...
this.show()
    ...
    methods: {
        ...
        get_user_decorated_coloring_list(inp)
        {
            if(this.offset<=this.types_count)
            {
                this.preload=true
                axios
                    .post('/get_user_decorated_coloring_list',{
                        offset:this.offset,
                    })
                    .then(({ data }) => (
