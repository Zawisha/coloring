    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="add_coloring_title">Ссылка на видео</div>
                ...
                <form @submit="formSubmit" enctype="multipart/form-data">
                    ...
                    <button class="btn btn-light add_coloring_title" :disabled='isDisabled_button'>Загрузить видео</button>
        ...
        formSubmit(e) {
            ...
            if(this.alert==false)
            {
                ...
                axios.post('/upload_video'
                    ,data,config)
                    .then(function (res) {
                        alert('Видео успешно добавлено, сейчас будет редирект на страничку добавления нового видео');
                        window.location.href =('/admin/add_video')
                    })
                    .catch((error) => {
                        this.isDisabled_button=false;
                       this.add_to_errors(error.response.data.errors);
